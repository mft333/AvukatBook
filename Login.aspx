                        ...
                        <form class="m-login__form m-form"> -->
                            ...
                            <div class="row m-login__form-sub">
                                ...
                                <div class="col m--align-right m-login__form-right">
                                    <a href="javascript:;" id="m_login_forget_password" class="m-link">Şifremi Unuttum </a>
                                </div>
                            </div>
                            <div class="m-login__form-action">
                                <asp:Button ID="m_login_signin_submit" runat="server" Text="Giriş Yap" OnClick="BtnGirisYap"  class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn m-login__btn--primary"/>
                            </div>
    <!-- begin:: Page    </form>--> 
                    </div>
                    <div class="m-login__signup">
                        ...
                        <form class="m-login__form m-form" action="">-->
                            ...
                            <div class="m-login__form-action">
                                <asp:Button ID="m_login_signup_submit" runat="server" Text="Kayıt Ol" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn" OnClick="m_login_signup_submit_Click"/>
                                &nbsp;&nbsp;
                                <asp:Button ID="m_login_signup_cancel" runat="server" Text="İptal" class="btn btn-outline-focus m-btn m-btn--pill m-btn--custom  m-login__btn" OnClick="m_login_signup_cancel_Click"/>
                    ...
                    <div class="m-login__forget-password">
                        ...
                        <form class="m-login__form m-form" action="">-->
                            ...
                            <div class="m-login__form-action">
                                <asp:Button ID="m_login_forget_password_submit" runat="server" Text="Sıfırla" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn m-login__btn--primaryr" OnClick="m_login_forget_password_submit_Click"/>
                                &nbsp;&nbsp;
                                <asp:Button ID="m_login_forget_password_cancel" runat="server" Text="İptal" class="btn btn-outline-focus m-btn m-btn--pill m-btn--custom m-login__btn" OnClick="m_login_forget_password_cancel_Click"/>
                            </div><!-- begin:: Page
                        </form> -->
                    </div>
